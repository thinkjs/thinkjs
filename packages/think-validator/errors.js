...
module.exports = {
  ...
  contains: '{name} need contains {args}',
  ...
  byteLength: '{name} need length (in bytes) with your options',
  ...
  email: '{name} need an email with your options',
  fqdn: '{name} need a fully qualified domain name with your options',
  float: '{name} need a float with your options',
  ...
  int: '{name} need an integer with your options',
  // minInt: '{name} need an integer greater than {args}',
  // maxInt: '{name} need an integer less than {args}',
  length: '{name} should be length with your options',
  // minLength: '{name} length should greater than {args}',
  // maxLength: '{name} length should less than {args}',
  ...
  url: '{name} need an URL with your options',
