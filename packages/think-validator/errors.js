...
module.exports = {
  ...
  byteLength: '{name} need length (in bytes) with your options', //fail
  ...
  fqdn: '{name} need a fully qualified domain name with your options',//done
  float: '{name} need a float with your options', //fail
  ...
  int: '{name} need an integer with your options', //fail
