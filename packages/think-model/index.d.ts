...
declare namespace NewThinkModel {
  export namespace think {
    const Model: ModelCls;
    function model(name: string, config?: any, module?: string): ModelCls;
  }
  namespace service {
    function model(name: string, config?: any, module?: string): ModelCls;
  }
...
declare module 'thinkjs' {
  interface Think extends NewThinkModel.think { }
  interface Controller extends NewThinkModel.controller { }
  interface Context extends NewThinkModel.context { }
