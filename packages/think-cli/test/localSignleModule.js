...
const cacheTemplatePath = path.join(__dirname, '.think-templates', 'localSignleModule')
const targetDir = 'tmp'
...
test.cb('should generate single module project from local default template', t => {
