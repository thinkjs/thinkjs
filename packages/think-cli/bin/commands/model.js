...
const run = new Run({
  ...
  targetPath: appPath,
  options: { name: thinkjsInfo.metadata.name, command: 'model', maps: 'model', context },
  done(err, files) {
