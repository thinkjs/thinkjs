...
describe('Db', function(){
  describe('Db.parseConfig', function(){
    it('empty config', function(){
      ...
      assert.deepEqual(config, {"type":"mysql","username":"root","password":"","hostname":"127.0.0.1","port":"","database":"","charset":"utf8", "rw_separate": false, "master_num": 1, "slave_no": undefined})
    })
    it('change type config', function(){
      var config = Db.parseConfig({db_type: 'mongodb'});
      assert.deepEqual(config, {"type":"mongodb","username":"root","password":"","hostname":"127.0.0.1","port":"","database":"","charset":"utf8", "rw_separate": false, "master_num": 1, "slave_no": undefined})
    })
  })
