...
module.exports = {
  ...
  db_socket: undefined, // MySQL Socket

  ssl_enabled: false,
  ssl_port: 8366,
  ssl_privatekey: APP_PATH + '/../ssl/privatekey.pem',
  ssl_certificate: APP_PATH + '/../ssl/certificate.pem',
