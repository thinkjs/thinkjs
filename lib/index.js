...
module.exports = think.Class({
  ...
  loadAlias: function(){
    ...
    var appAlias = think.safeRequire(think.getCommonModulePath() + '/' + think.dirname.config + '/alias.js');
    think._alias = extend({}, alias, appAlias);
  },
  /**
   * load middleware
   * @return {} []
  ...
  loadMiddleware: function(){
    ...
    var paths = [
      ...
      think.getCommonModulePath() + '/' + think.dirname.middleware
    ]
