    ...
    return {
        ...
        exec: function(){
            ...
            if (!controller) {
                ...
                return send_status(this.http.res, 404);
            };
            ...
            send_status(this.http.res, 404);
            return get_promise("action: " + action + " not found", true);
        },
        /**
...
module.exports.run = function(){
    //命令行调用
    if (CLI_REQUEST) {
        var http = think_require("Http").cli(CLI_REQUEST);
...
module.exports.createServer = function(){
    var server = require("http").createServer(function (req, res) {
        think_require("Http")(req, res).run(App.listener);
    });
    var params = [C('port')];
    //禁止外网直接通过IP访问
