...
var Model = module.exports = Class(function(){
  ...
  return {
    ...
    getTableFields: function(table, all){
      ...
      var self = this;
      //从数据表里查询字段信息
      return this.flushFields(table).then(function(fields){
        self.fields = fields;
     ...
     * @return {[type]}       [description]
     */
    table: function(table, prefix){
      if (!table) {
        return this;
      }
      this._options.table = prefix ? table : this.tablePrefix + table;
      return this;
    },
    /**
     * 联合查询
