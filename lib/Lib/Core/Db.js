 ...
 */
var getComparison = function(value) {
  var comparisonUpper = value.toUpperCase();
  comparisonUpper = comparison.COMPARISON[comparisonUpper] || comparisonUpper;
  if (comparison.COMPARISON_LIST.indexOf(comparisonUpper) > -1) {
    return comparisonUpper;
  }
      ...
      if (isString(val[0])) {
        ...
        for(var i = 0; i < length; i++){
          ...
          if (exp === 'EXP') {
            ...
            var op = isArr ? getComparison(val[i][0]) : '=';
