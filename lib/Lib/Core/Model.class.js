        ...
        add: function(data, options, replace){
            ...
            if (is_empty(data)) {
                if (this._data) {
                    ...
                    return get_promise(L("_DATA_TYPE_INVALID_"), true);
                }
            };
            var self = this;
            return this.parseOptions(options).then(function(options){
                ...
                if (data === false) {
                    return get_promise("_beforeInsert return false", true);
                };
        ...
        update: function(data, options){
            ...
            return this.parseOptions(options).then(function(options){
                ...
                if (self._beforeUpdate(data, options) === false) {
                    return get_promise("_beforeUpdate return false", true);
                };
                var pkValue = "";
                var pk = self.getPk();
                if (is_empty(self.options.where) && is_empty(options.where)) {
                    ...
                    if (!is_empty(data[pk])) {
                        ...
                        return get_promise(L("_OPERATION_WRONG_"), true);
                    }
                };
