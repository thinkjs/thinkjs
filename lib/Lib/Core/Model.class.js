...
var model = module.exports = Class(function(){
    ...
    return {
        ...
        flushFields: function(){
            ...
            var self = this;
            return this.db.getFields(this.getTableName()).then(function(fields){
                self.fields = {"_field": Object.keys(fields)};
                self.fields['_autoinc'] = false;
                var types = {};
        ...
        getFields: function(){
            if (this.options.table) {
                this.db.getFields(this.options.table).then(function(fields){
                    var keys = Object.keys(fields);
                })
            };
            if (this.fields) {
                var fields = extend({}, this.fields);
                delete this.fields['_autoinc'];
                delete this.fields['_pk'];
                delete this.fields['_type'];
                delete this.fields['_version'];
                return get_promise(fields);
            };
            return get_promise(false);
        },
    ...
    methodNameList = ['count','sum','min','max','avg'];
    methodNameList.forEach(function(item){
        methods[item] = function(data){
            var field = data || "*";
