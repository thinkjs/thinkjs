...
module.exports = think.Class({
  ...
  bind: function(){
    ...
    this.http._end = this._end;
    this.http.sendTime = this.sendTime;
    this.http.type = this.type;
    this.http.success = this.success;
    this.http.fail = this.fail;
    this.http.jsonp = this.jsonp;
    this.http.json = this.json;
  },
  /**
   * get or set config
  ...
  success: function(data, message){
    ...
    var obj = this.getObject(key, [0, message || '']);
    if (data !== undefined) {
      obj.data = data;
    }
